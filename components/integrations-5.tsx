        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="bg-linear-to-t from-background relative z-20 mx-auto mt-12 max-w-lg space-y-6 from-55% text-center">
            <h2 className="text-balance text-3xl font-semibold md:text-4xl">
              Seamlessly Integrate with Global Tools
            </h2>
            <p className="text-muted-foreground">
              Connect effortlessly with the world’s most popular platforms —
              from design to deployment — and supercharge your productivity.
            </p>
          </div>
        </div>
      </div>
