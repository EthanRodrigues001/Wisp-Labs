      ...
      <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
        <div>
          <div className="p-6 sm:p-12">
            ...
            <p className="mt-8 text-2xl font-semibold">
              Seamlessly track project milestones — no matter where you&apos;re
              located.
            </p>
          </div>
          ...
          <div aria-hidden className="relative">
            <div className="absolute inset-0 z-10 m-auto size-fit">
              <div className="rounded-(--radius) bg-background z-1 dark:bg-muted relative flex size-fit w-fit items-center gap-2 border px-3 py-1 text-xs font-medium shadow-md shadow-zinc-950/5">
                <span className="text-lg">🌍</span> Targetting Globally
              </div>
        ...
        <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l dark:bg-transparent">
          <div className="relative z-10">
            ...
            <p className="my-8 text-2xl font-semibold">
              Collaborate via email or chat across time zones — we’re always
              ready to assist.
            </p>
          </div>
          <div aria-hidden className="flex flex-col gap-8">
            ...
            <div>
              <div className="rounded-(--radius) mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">
                Sure, let&apos;s find a time that works for your region.
              </div>
        ...
        <div className="col-span-full border-y p-12">
          <p className="text-center text-4xl font-semibold lg:text-7xl">
            99.99% UPTIME — your website is always available, globally
          </p>
        </div>
        <div className="relative col-span-full">
          <div className="absolute z-10 max-w-lg px-6 pr-12 pt-6 md:px-12 md:pt-12">
            ...
            <p className="my-8 text-2xl font-semibold">
              Instantly view updates from your dedicated team{" "}
              <span className="text-muted-foreground">
                {" "}
                — mobile or desktop, wherever you are.
              </span>
            </p>
          </div>
          <MonitoringChart />
